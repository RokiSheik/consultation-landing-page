        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                  ...
                  <form action="submit-form.php" method="POST" style="display: flex; flex-wrap: wrap; gap: 15px;" class="content-lead-form">
                      <h2 style="width: 100%; text-align: center; margin-bottom: 20px;">Registration Form</h2>

                      <label style="width: 100%;">Name:<span style="color:red;">*</span>
                          <input type="text" name="name" required style="width: 100%; padding: 8px; margin-top: 5px; border: 1px solid #ccc; border-radius: 5px;">
                      </label>

                      <label style="width: 100%;">WhatsApp Number:<span style="color:red;">*</span>
                          <input type="text" name="whatsapp" required style="width: 100%; padding: 8px; margin-top: 5px; border: 1px solid #ccc; border-radius: 5px;">
                      </label>

                      <label style="width: 100%;">Profession:<span style="color:red;">*</span>
                          <input type="text" name="profession" required style="width: 100%; padding: 8px; margin-top: 5px; border: 1px solid #ccc; border-radius: 5px;">
                      </label>

                      <label style="width: 100%;">Business Type:<span style="color:red;">*</span>
                          <input type="text" name="business_type" required style="width: 100%; padding: 8px; margin-top: 5px; border: 1px solid #ccc; border-radius: 5px;">
                      </label>

                      <label style="width: 100%;">Current Revenue:<span style="color:red;">*</span>
                          <input type="text" name="current_revenue" required style="width: 100%; padding: 8px; margin-top: 5px; border: 1px solid #ccc; border-radius: 5px;">
                      </label>

                      <label style="width: 100%;">Future Revenue Target:<span style="color:red;">*</span>
                          <input type="text" name="future_revenue" required style="width: 100%; padding: 8px; margin-top: 5px; border: 1px solid #ccc; border-radius: 5px;">
                      </label>

                      <label style="width: 100%;">Total Team Members:<span style="color:red;">*</span>
                          <input type="number" name="total_team" class="button-margin-top" required style="width: 100%; padding: 8px; margin-top: 5px; border: 1px solid #ccc; border-radius: 5px;">
                      </label>
                      <input type="hidden" name="landing_title" value="<?php echo $data['data']['section1']['title']; ?>">
                    <input type="hidden" name="offer_price" value="<?php echo (int)$data['data']['section1']['offer_price']; ?>">


                      <button class="content-lead-form" type="submit" style="width: 50%; background: black; color: white; padding: 12px; margin-top: 20px; border: none; border-radius: 5px; font-size: 18px; cursor: pointer;">
                          Submit
                      </button>
                  </form>
</div>
